...
$harnessRoot = Join-Path $spikeRoot 'HarnessGraphView'
...
if ([string]::IsNullOrWhiteSpace($OutputPath)) {
    ...
    $OutputPath = Join-Path $spikeRoot "..\..\Planning~\Evidence\P3-014\spike-results-$stamp.json"
}
...
$arguments = @(
    ...
    '-executeMethod', 'AIBT.Spikes.EditorGraphFrameworkGraphView.SpikeRunner.Run',
