...
Copy-Item -LiteralPath $driverSource -Destination (Join-Path $isolatedHarnessRuntime 'SchedulingPolicyDriver.cs')
Copy-Item -LiteralPath $scenariosSource -Destination (Join-Path $isolatedHarnessRuntime 'SchedulingScenarios.cs')
